...
- **1167 tests, 56 files, all green** (1158 passed + 9 platform-conditional skips).
  Coverage statements 96.25 / branches 92.32 / functions 97.9 / lines 96.8 against the
...
- `npm run test:coverage` — 1158 passed + 9 skipped across 56 files; statements 96.25 /
  branches 92.32 / functions 97.9 / lines 96.8 ≥ thresholds 93 / 88 / 94 / 93
...
- `npm pack --dry-run` — 7 files, 102.5 kB packed
