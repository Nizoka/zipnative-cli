...
- 1167 vitest tests across 56 files (1158 passed + 9 platform-conditional skips) green on
  Ubuntu (Node 22, 24), Windows (Node 22, 24) and macOS (Node 22); coverage statements
  96.25 % / branches 92.32 % / functions 97.9 % / lines 96.8 % against the enforced thresholds
  93 / 88 / 94 / 93.
...
- `npm audit` clean; `npm run lint` (src and tests) 0 errors; built binary smoke-tested
  ...
  73/73.
- Package: 7 files, 102.5 kB packed — `dist/cli.cjs`, `AGENTS.md`,
