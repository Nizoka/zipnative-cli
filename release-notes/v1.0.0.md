...
- 1184 vitest tests across 57 files (1175 passed + 9 platform-conditional skips) green on
  Ubuntu (Node 22, 24), Windows (Node 22, 24) and macOS (Node 22); coverage statements
  96.27 % / branches 92.36 % / functions 97.91 % / lines 96.81 % against the enforced thresholds
  93 / 88 / 94 / 93.
...
- `npm audit` clean; `npm run lint` (src and tests) 0 errors; built binary smoke-tested
  ...
  73/73.
- Package: 7 files, 116.7 kB packed — `dist/cli.cjs`, `AGENTS.md`,
